...
export default function Card_home1() {
  return (
    <div className="Card_home1">
        ...
        <Card_home img={'https://images.squarespace-cdn.com/content/v1/51cdafc4e4b09eb676a64e68/9c25e4d4-ad11-421d-ab84-afda6157e3a5/wl_lower.jpg?format=1500w'} about={'WIN OR LOSE'} link={'/win-or-lose'}/>
    </div>
)
}
